...
/**
 * Démo seulement — l'authentification réelle (NextAuth.js / Auth.js +
 * JWT WordPress côté serveur, cookie HttpOnly SameSite=Lax) est implémentée
 * lors du sprint d'auth, cf. README "State management".
 */
  ...
  return (
    <>
      ...
      <div className="mt-4 text-center">
        <Link
          href="/auth/magic"
          className="text-[13px] text-primary font-semibold underline"
        >
